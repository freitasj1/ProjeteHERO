...
const image = document.querySelector("#imgrotate");
let mouseX, mouseY;
let angleX = 0;
let angleY = 0;
...
container.addEventListener("mousemove", (e) => {
    ...
    mouseX = (e.clientX - container.getBoundingClientRect().left) - centerX;
    mouseY = centerY - (e.clientY - container.getBoundingClientRect().top);
    
    angleY = (mouseX / centerX) * 30; // Ajuste a sensibilidade de rotação aqui
    angleX = (mouseY / centerY) * 30; // Ajuste a sensibilidade de rotação aqui
